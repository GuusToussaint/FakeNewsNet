...
def get_user_ids_in_folder(samples_folder):
    ...
    for news_id in os.listdir(samples_folder):
        ...
        if is_folder_exists(news_dir) and is_folder_exists(retweets_dir):
            ...
            for retweet_file in os.listdir(retweets_dir):
                ...
                # except:
                #     logging.warning("file raised error {}".format("{}/{}".format(retweets_dir, retweet_file)))
...
class UserTimelineTweetsCollector(DataCollector):
    ...
    def __init__(self, config):
        ...
        logging.info("Started the user timeline collection function")
